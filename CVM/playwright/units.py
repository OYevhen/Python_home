...
class CVM:
    ...
    def create_standard_volumes(self):
        ...
        self.page.locator(".checkbox-custom").nth(1).click()    #self.page.locator("tr:nth-child(2) > .wizard_table__table_body_checkbox_wrapper > .checkbox-label > .checkbox-custom").click()
        self.page.get_by_role("button", name="Next").click()
